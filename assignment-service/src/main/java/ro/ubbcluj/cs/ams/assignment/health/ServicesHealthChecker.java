package ro.ubbcluj.cs.ams.assignment.health;
...
public class ServicesHealthChecker {
    ...
    private static final long INITIAL_SEND_INTERVAL = 3000;
                ...
                services.forEach(service -> {
                    if (!detectedServices.contains(service) ||
                            (detectedServices.contains(service) && service.isCalledMe() &&
                                    detectedServices.get(detectedServices.indexOf(service)).getTimesNoRun() < 4)) {
